...
enum AquaOLEndpoint {
    ...
    static let coversBase = URL(string: "https://covers.openlibrary.org")!
    ...
    static func coverURL(coverId: Int, size: String = "M") -> URL {
        coversBase.appendingPathComponent("b/id/\(coverId)-\(size).jpg")
    }
}
